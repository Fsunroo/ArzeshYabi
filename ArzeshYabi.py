...
Driver.find_element_by_xpath('/html/body/div[4]/div[2]/div[1]/a[1]/span[2]').click()
time.sleep(1.5)
Driver.switch_to_frame(Driver.find_element_by_id("iframe_040101"))
Driver.find_element_by_xpath('/html/body/form/div[3]/div/div[1]/div[1]/div[3]/div/input').send_keys(UserName)
Driver.find_element_by_xpath('/html/body/form/div[3]/div/div[1]/div[1]/div[4]/div/input').send_keys(PassWord)
Driver.find_element_by_xpath('/html/body/form/div[3]/div/div[1]/div[1]/div[6]/input').click()
...
while True:
	...
	def choose_12():
		for i in range(2,12):
			x_path = '/html/body/form/div[4]/div/div/table/tbody/tr['+str(i)+']/td[12]/input[9]'
